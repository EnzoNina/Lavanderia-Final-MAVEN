...
public class ServletConfirmacionVisita extends HttpServlet {
    ...
    private void generarBoleta(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Preparando Boleta");
        ...
        try {
            InputStream logoEmpresa = this.getServletConfig()
                    ...
                    reporteBoleta = this.getServletConfig()
                            .getServletContext()
                            .getResourceAsStream("jasperReports/Boleta.jasper");
            if (logoEmpresa != null && reporteBoleta != null) {
                ...
                JasperReport report = (JasperReport) JRLoader.loadObject(reporteBoleta);
                ...
                out.println(
                        "ERROR: Esto puede debrse a que la lista de datos no fue recibida o el archivo plantilla del reporte no se ha encontrado");
            }
        } catch (Exception e) {
            response.setContentType("text/plain");
